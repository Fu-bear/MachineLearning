...
def datingClassTest():
    ...
    datingDataMat, datingLabels = file2matrix(
        "E:/project/MachineLearning/input/2.KNN/datingTestSet2.txt")  # load data setfrom file
    # 归一化数据
...
def handwritingClassTest():
    ...
    trainingFileList = os.listdir(
        "E:/project/MachineLearning/input/2.KNN/trainingDigits")  # load the training set
    ...
    for i in range(m):
        ...
        trainingMat[i] = img2vector(
            'E:/project/MachineLearning/input/2.KNN/trainingDigits/%s' % fileNameStr)

    # 2. 导入测试数据
    # iterate through the test set
    testFileList = os.listdir('E:/project/MachineLearning/input/2.KNN/testDigits')
    errorCount = 0
    ...
    for i in range(mTest):
        ...
        vectorUnderTest = img2vector(
            'E:/project/MachineLearning/input/2.KNN/testDigits/%s' % fileNameStr)
